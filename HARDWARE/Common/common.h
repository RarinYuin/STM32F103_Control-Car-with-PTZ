...
#define SEND_CC 0x04
#define SEND_START_OK 0x08
#define SEND_READ_FILE 0x10
#define SEND_SEND_FILE 0x20
#define SEND_SET_OFFLINE_OK 0x40
#define SEND_SET_DISABLEOFFLINE_OK 0x80
#define SEND_SET_ONLINE_OK 0x100
#define SEND_SET_DELETE_ONE_FILE_OK 0x200
#define SEND_SET_DELETE_ALL_FILE_OK 0x400
#define SEND_SET_PS2_OK 0x800
#define SEND_SET_READ_UART_MOTOR_ANGLE 0x1000
#define SEND_SET_SET_UART_MOTOR_PULK 0x2000
#define SEND_SET_SET_UART_MOTOR_ANGLE 0x4000
#define SEND_SET_BEEP_ON 0x8000
#define SEND_SET_BEEP_OFF 0x10000
